        ...
        <header className="sticky top-0 z-40 flex items-center justify-between px-8 h-16 w-full bg-[#0b1326]/80 backdrop-blur-md border-b border-white/5">
          ...
          <div className="flex items-center gap-6">
            <div className="relative w-96">
              ...
              <input
                className="w-full bg-surface-container-lowest border-none rounded-lg py-2 pl-10 pr-4 text-xs text-slate-300 focus:ring-1 focus:ring-primary/40 placeholder-slate-600 transition-all"
                placeholder="Search issues, traces, or users (Cmd+K)"
                type="text"
              />
            </div>
              ...
              <div>
                ...
                <div className="flex -space-x-2 mt-3">
                  <img
                    ...
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDky3rz6sEEnwpc0mzeiwOI32sQXz92Mgk32VNbxHQDVtn7rLIsW90DD8g7c-qkS3px1xqF7o73HMt6IdpPZ8Ugymcmx_qtjKcG1pFrpx2ud5BQINz3BxjHN1eRf1FhW5GFThyBBn2kifR4yNmSiJv_fyVWOeuOPpm2DOrv_Vv8kvly2L34kIVtgbh2gtAuewiIYwFxLMKi1AePwqU9a-WpoCco4FdUj6FCGGlzkTx5bsivsKr6P2mZ_-XxDdqtJVa-gLSL5cbaWS8"
                  />
                  <img
                    alt="Senior Dev"
                    className="w-8 h-8 rounded-full border-2 border-surface-container-low"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCFmr4TUBAH_2klxnTuvwBuHFwyooiYOP47Gyv2nUqnHFjiXD3axgtuByYkeh5_-Ya58_TmSOfpI-lobQh1og-E7clW7Spc9J53LjeMztHuDU8bnVxUL3sNS07SCfIBwUswTsW5K1bmmsJl28RLM5hgtakXpRzIpMyf5OnJTnArJfrriNYr06yKO73oSXsSohpJOtJYAA-wN9HTpWMRcnB2wtERCwPFraCa-mPZwJYKNDtaCbvcUIMRhEwQ1n13y8KX6YG2x8eUvus"
                  />
                  <img
                    alt="Dev"
                    className="w-8 h-8 rounded-full border-2 border-surface-container-low"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCm_CxvNbD20BP6oqnNYimBdiCtSyhVHsTZNuA7_J6JSjElAGD8nrmUU8LBuBAHcoA6gKqxbSLGcAxO4mPeZEL-yP5CIiSme4HhD513JOqUdRdF0UzuKz-Kl1lbgLFN-wzp9VFf3ouULoXNKSPXpXvDfggGsi_m4zh7Tz47fGFnRlP9D9C3EJ5ii56aFZC_9mUvjs6mNMHCD_eRZ5mQVm9A3bY_nthQOmK5zHJFSH0JcYZGcL8RHQ0EhriDvkI5XqrIDu7ffFphaTs"
                  />
                  <div className="w-8 h-8 rounded-full border-2 border-surface-container-low bg-surface-container-highest flex items-center justify-center text-[10px] font-bold text-slate-300">
                    +4
                  </div>
                </div>
              </div>
              <button className="px-4 py-2 bg-gradient-to-r from-primary to-primary-container text-on-primary text-xs font-bold rounded shadow-lg active:scale-95 transition-transform tracking-tight">
                CREATE INCIDENT
              </button>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low rounded-xl overflow-hidden border border-white/5 shadow-2xl">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-surface-container-low/50">
                  <th className="px-6 py-4 text-[10px] font-bold tracking-widest text-slate-500 uppercase">
                    Issue Details
                  </th>
                  <th className="px-6 py-4 text-[10px] font-bold tracking-widest text-slate-500 uppercase">
                    Context
                  ...
                  <th className="px-6 py-4 text-[10px] font-bold tracking-widest text-slate-500 uppercase text-right">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                ...
                <tr className="group hover:bg-white/[0.02] transition-colors relative">
                  ...
                  <td className="px-6 py-5">
                    <span className="px-2 py-0.5 rounded-[4px] bg-error-container text-on-error-container text-[10px] font-black uppercase tracking-tight">
                      Critical
                    </span>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuC6uYaQ57X8yGPry8rY_UjVrnb1FwbR8Ya1Q0p3VY54Fjd_c80yK6l3INASPjEFBSoSbcnBZeIzWNpLUnM7bBBtG5rXIy6ZRiiulT7jex54rRmVyXNXy8E7JqdEI6IAFhrkb4ZSRt2vhiSR2KjMmm7lTtEGh0AIH4mmI-Ca33EtOPtt4fGYqrMY2RwtswQ5EtyTWTh3GkoZHW5HDI8SchSYqhLN-NCJJ79GFk4yYycjEB3bOOKp56BDg6x4dLGPR2pODxWQ4PEIx68"
                      />
                ...
                <tr className="group hover:bg-white/[0.02] transition-colors relative">
                  <td className="px-6 py-5">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-sm font-semibold text-white group-hover:text-primary transition-colors">
                        NullPointerException in DiscountCalculator
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5">
                    <span className="px-2 py-0.5 rounded-[4px] bg-tertiary-container text-on-tertiary-container text-[10px] font-black uppercase tracking-tight">
                      Medium
                    </span>
                  </td>
                  <td className="px-6 py-5">
                ...
                <tr className="group hover:bg-white/[0.02] transition-colors relative">
                  <td className="px-6 py-5">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-sm font-semibold text-white group-hover:text-primary transition-colors">
                        Deadlock detected in DB connection pool
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                ...
                <tr className="group hover:bg-white/[0.02] transition-colors relative">
                  <td className="px-6 py-5">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-sm font-semibold text-white group-hover:text-primary transition-colors">
                        Incorrect total amount on PDF invoices
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5">
                    <span className="px-2 py-0.5 rounded-[4px] bg-secondary-container text-on-secondary-container text-[10px] font-black uppercase tracking-tight">
                      Low
                    </span>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-2">
                      <img
                        alt="David"
                        className="w-6 h-6 rounded-full"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuA7pEwwWqxjgQDYx_fpAGAYJar2-CW_iEE6pfP_K_grENP0W9SohsEUDhz_qHeO9Zc66R0p4nepv4XPUbOlZYVFTQb9RzwpRHGYZLXi3erwe2-aaHx5wVWZL_2ml_WFVkcdZgbs7pi5RBYUsPoSoUx6_CvmmXxAV8yi4tiJ1vjrnXaQ0h8DtYbtPVtwZ08MUfYrZ5UaDkdGpL1kjB593t_qhRzsXu7vk7LYc1IhZ0PSgp0FMZaI2Vore32SxamaWqAN9OjN7lKXKi0"
                      />
            ...
            <div className="px-6 py-4 bg-surface-container-low border-t border-white/5 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button className="w-8 h-8 flex items-center justify-center rounded bg-primary text-on-primary font-bold text-[10px]">
                  1
                </button>
                <button className="w-8 h-8 flex items-center justify-center rounded border border-white/5 text-slate-500 hover:text-white transition-colors text-[10px]">
                  2
                </button>
                <button className="w-8 h-8 flex items-center justify-center rounded border border-white/5 text-slate-500 hover:text-white transition-colors text-[10px]">
                  3
          ...
          <div className="mt-10 grid grid-cols-3 gap-6">
            <div className="col-span-2 bg-surface-container-low rounded-xl border border-white/5 p-6 overflow-hidden">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <span className="px-2 py-0.5 bg-surface-container-highest text-[9px] text-slate-400 font-bold rounded">
                    RAW LOG
                  </span>
                  <span className="px-2 py-0.5 bg-surface-container-highest text-[9px] text-primary font-bold rounded">
                    FORMATTED
                  </span>
                </div>
              </div>
              <div className="bg-surface-container-lowest rounded-lg p-4 font-mono text-[11px] leading-relaxed text-slate-400 custom-scrollbar max-h-[240px] overflow-y-auto">
                ...
                <div className="flex gap-4 mb-1 pl-4 opacity-75">
                  <span className="text-slate-600">
                    at
                    com.acme.gateway.CheckoutService.processLargePayload(CheckoutService.java:142)
                  </span>
                </div>
                <div className="flex gap-4 mb-1 pl-4 opacity-75">
                  <span className="text-slate-600">
                    at
                    com.acme.gateway.CheckoutService.handleRequest(CheckoutService.java:89)
                  </span>
                </div>
                <div className="flex gap-4 mb-1 pl-4 opacity-75">
                  <span className="text-slate-600">
                    at
                    com.acme.gateway.CheckoutController.checkout(CheckoutController.java:45)
                  </span>
                </div>
                <div className="flex gap-4 mb-1">
                  ...
                  <span className="text-slate-400 tracking-tight">
                    Connection pool exhausted. Waiting for available
                    connection...
                  </span>
                </div>
                <div className="flex gap-4 mb-1">
                  ...
                  <span className="text-slate-200 tracking-tight">
                    System termination signal received. Dumping core...
                  </span>
                </div>
              </div>
            </div>
            <div className="col-span-1 bg-surface-container-low rounded-xl border border-white/5 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-surface-container-highest rounded-lg border border-error/20">
