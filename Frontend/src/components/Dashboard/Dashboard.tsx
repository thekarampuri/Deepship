    ...
    <div className="bg-surface text-on-surface font-body overflow-x-hidden min-h-screen">
      ...
      <nav className="fixed left-0 top-0 h-full flex flex-col py-6 px-4 bg-slate-900/50 backdrop-blur-xl h-screen w-64 border-r border-white/5 shadow-2xl z-[60]">
        ...
        <div className="space-y-1 flex-1">
          ...
          <a className="flex items-center gap-3 px-3 py-2.5 rounded transition-all duration-200 ease-in-out text-slate-400 hover:text-slate-100 hover:bg-[#131b2e] scale-[0.98] active:scale-95" href="#">
            ...
            <span className="font-sans text-sm tracking-tight text-slate-400">Teams</span>
          </a>
        </div>
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between px-8 ml-64 w-[calc(100%-16rem)] bg-[#0b1326]/80 backdrop-blur-md h-16 border-b border-white/5 no-shadows">
        ...
        <div className="flex items-center gap-6">
          <div className="relative group">
            ...
            <input className="bg-surface-container-lowest border-none rounded-lg py-1.5 pl-10 pr-4 w-64 text-sm focus:ring-1 focus:ring-primary/40 transition-all" placeholder="Global search telemetry..." type="text"/>
          </div>
      ...
      <main className="ml-64 p-8 min-h-[calc(100vh-4rem)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Total Logs */}
          <div className="bg-surface-container-high p-6 rounded-lg relative overflow-hidden group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 bg-surface-container-low rounded-lg p-6">
            ...
            <div className="h-64 flex items-end gap-1 overflow-hidden">
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[40%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[50%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[45%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-tertiary/20 to-tertiary/5 h-[30%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-error/40 to-error/10 h-[80%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[60%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[55%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[70%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-tertiary/20 to-tertiary/5 h-[40%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[45%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-error/40 to-error/10 h-[65%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[50%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[42%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[38%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[55%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-error/40 to-error/10 h-[90%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[45%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[30%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[50%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-secondary/20 to-secondary/5 h-[60%] rounded-t-sm"></div>
              <div className="flex-1 bg-gradient-to-t from-tertiary/20 to-tertiary/5 h-[40%] rounded-t-sm"></div>
            </div>
            <div className="mt-4 flex justify-between px-2 text-[10px] text-slate-500 font-bold">
              <span>12:00 PM</span>
              <span>03:00 PM</span>
              <span>06:00 PM</span>
              <span>09:00 PM</span>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden">
                  <div className="bg-error h-full rounded-full w-[85%]"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-[11px] mb-2 font-bold">
                ...
                <div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden">
                  <div className="bg-error h-full rounded-full w-[45%] opacity-80"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-[11px] mb-2 font-bold">
                ...
                <div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden">
                  <div className="bg-tertiary h-full rounded-full w-[35%]"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-[11px] mb-2 font-bold">
                ...
                <div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden">
                  <div className="bg-tertiary h-full rounded-full w-[15%] opacity-70"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-[11px] mb-2 font-bold">
                ...
                <div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden">
                  <div className="bg-secondary h-full rounded-full w-[8%]"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-surface-container-low rounded-lg overflow-hidden">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm divide-y divide-white/5">
                ...
                <tr className="group hover:bg-surface-container-high transition-colors severity-bar-error">
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-white font-semibold">NullPointerException: User.auth_token</span>
                      <span className="text-slate-500 text-xs font-mono uppercase mt-1">ID: #INC-8821</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-slate-300 font-medium">Acme-Auth-Pro</span>
                      <span className="text-slate-500 text-xs uppercase mt-1">auth-service / main-cluster</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <span className="px-2 py-0.5 rounded bg-error-container text-on-error-container text-[10px] font-black uppercase">Fatal</span>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-2">
                ...
                <tr className="group hover:bg-surface-container-high transition-colors severity-bar-error">
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-white font-semibold">ConnectionTimeout: DB_READ_REPLICA_02</span>
                      <span className="text-slate-500 text-xs font-mono uppercase mt-1">ID: #INC-8819</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-slate-300 font-medium">Inventory-Core</span>
                      <span className="text-slate-500 text-xs uppercase mt-1">db-proxy / primary</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <span className="px-2 py-0.5 rounded bg-error-container text-on-error-container text-[10px] font-black uppercase">Error</span>
                  </td>
                  <td className="px-8 py-5">
                ...
                <tr className="group hover:bg-surface-container-high transition-colors severity-bar-warn">
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-white font-semibold">SlowQueryWarning: product_search_aggregate</span>
                      <span className="text-slate-500 text-xs font-mono uppercase mt-1">ID: #INC-8815</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-slate-300 font-medium">Acme-Storefront</span>
                      <span className="text-slate-500 text-xs uppercase mt-1">search-api / us-east-1</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <span className="px-2 py-0.5 rounded bg-tertiary-container text-on-tertiary-container text-[10px] font-black uppercase">Warning</span>
                  </td>
                  <td className="px-8 py-5">
                ...
                <tr className="group hover:bg-surface-container-high transition-colors severity-bar-error">
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-white font-semibold">502 Bad Gateway: edge-proxy-ingress</span>
                      <span className="text-slate-500 text-xs font-mono uppercase mt-1">ID: #INC-8812</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex flex-col">
                      <span className="text-slate-300 font-medium">Network-Infrastructure</span>
                      <span className="text-slate-500 text-xs uppercase mt-1">gateway-v2 / global</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <span className="px-2 py-0.5 rounded bg-error-container text-on-error-container text-[10px] font-black uppercase">Error</span>
          ...
          <div className="px-8 py-4 text-center border-t border-white/5">
            <button className="text-xs font-bold text-slate-400 hover:text-white transition-colors">View All Incidents (142)</button>
          </div>
        </div>
      </main>
    </div>
